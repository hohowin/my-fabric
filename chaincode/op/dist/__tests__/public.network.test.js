...
describe('Chaincode Network Tests', () => {
    ...
    it('should queryByEntityId', async () => execa_1.default('docker', [...base_args, ...query_args, `{"Args":["queryByEntityId","${entityName}","${id}"]}`])
    ...
    it('should createCommit #1', async () => execa_1.default('docker', [
        ...base_args,
        ...invoke_args,
        `{"Args":["createCommit","${entityName}","id_00001","0","${eventStr}","${ledger_api_1.createCommitId()}"]}`
    ...
    it('should queryByEntityId #2', async () => execa_1.default('docker', [...base_args, ...query_args, `{"Args":["queryByEntityId","${entityName}","id_00001"]}`])
    ...
    it('should fail to queryByEntityId', async () => execa_1.default('docker', [...base_args, ...query_args, `{"Args":["queryByEntityId","${entityName}","id_00001"]}`])
    ...
    it('should fail to createCommit', async () => execa_1.default('docker', [
        ...base_args,
        ...invoke_args,
        `{"Args":["createCommit","${entityName}","","0","${eventStr}","${ledger_api_1.createCommitId()}"]}`
